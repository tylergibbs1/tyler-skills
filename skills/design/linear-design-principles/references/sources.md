...
- A design reset: https://linear.app/now/a-design-reset
...
- Design for the AI age: https://linear.app/now/design-for-the-ai-age
...
- *Linear's secret to building beloved B2B products*, Lenny's Podcast with Nan Yu, Jan 2025: https://www.lennysnewsletter.com/p/linears-secret-to-building-beloved-b2b-products-nan-yu
- *Karri Saarinen: 10 rules for crafting products that stand out*, Figma blog: https://www.figma.com/blog/karri-saarinens-10-rules-for-crafting-products-that-stand-out/
- *The Linear Method: opinionated software* (Jori Lallo, Cristina Cordova), Figma blog: https://www.figma.com/blog/the-linear-method-opinionated-software/
- *Inside Linear: why craft and focus still win*, First Round Review podcast with Karri Saarinen: https://review.firstround.com/podcast/inside-linear-why-craft-and-focus-still-win-in-product-building/
- Nan Yu deep dives: The Glimpse interview (https://www.theglimpse.co/p/nan-yu), Aakash Gupta's Linear Method breakdown (https://www.news.aakashg.com/p/nan-yu-podcast), LaunchPod episode
...
## Peer companies (for `boundaries-and-peers.md` and corroboration)
Used to test where Linear's principles generalize, where they break, and where the broader canon independently agrees. Verified by a fact-checking pass; per-source caveats below.
...
- Built for speed (100ms rule): https://blog.superhuman.com/superhuman-is-built-for-speed/
...
- Game design, not gamification: https://blog.superhuman.com/game-design-not-gamification/

**Notion / Raycast / shadcn / Vercel** (flexibility, extensibility, design engineering, codified craft)
- Raycast extensions / technical deep dive: https://www.raycast.com/blog/how-raycast-api-extensions-work · https://www.raycast.com/blog/a-technical-deep-dive-into-the-new-raycast
- shadcn/ui (you own the code): https://ui.shadcn.com/docs
- Vercel design engineering (no handoff): https://vercel.com/design/engineer · https://vercel.com/blog/design-engineering-at-vercel
- Vercel Web Interface Guidelines (shipped as an agent command): https://vercel.com/design/guidelines · https://vercel.com/changelog/web-interface-guidelines-now-available-as-an-agent-command
- Rauno Freiberg, interfaces (quantified craft details): https://github.com/raunofreiberg/interfaces

**Basecamp / 37signals** (Shape Up: appetite, no backlog, cooldown, circuit breaker)
- Shape Up: https://basecamp.com/shapeup · circuit breaker: https://basecamp.com/shapeup/2.2-chapter-08 · appetite: https://basecamp.com/shapeup/0.3-chapter-01
- Getting Real (opinionated software, start with no): https://basecamp.com/gettingreal

**Intercom** (start with the problem, JTBD, RICE, ship-to-learn, say no)
- Product principles: https://www.intercom.com/blog/intercom-product-principles/ · start with the problem: https://www.intercom.com/blog/intercom-product-principles-start-with-the-problem/
- Shipping is the beginning: https://www.intercom.com/blog/shipping-is-the-beginning/ · outcomes vs features: https://www.intercom.com/blog/outcomes-vs-features/
...
**The Browser Company** (the novelty tax; killing Arc)
- Letter to Arc members (2025): https://browsercompany.substack.com/p/letter-to-arc-members-2025 · Every interview (why they killed Arc for Dia): https://every.to/podcast/transcript-7d7adc44-103b-4483-a5a2-29a713085e33
