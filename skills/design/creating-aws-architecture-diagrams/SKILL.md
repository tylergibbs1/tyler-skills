...
5. **Render the requested format.** Use Mermaid for an editable documentation
   ...
   wants this skill's default visual language. Treat it as a generic public
   example: explicitly replace its topology and text unless the requested
   system uses that same standard serverless web pattern.
